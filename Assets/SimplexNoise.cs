...
public static class SimplexNoise{
	...
	public static void initSimplexNoise() {
    ...
    public static double noise(double xin, double yin) {
        ...
        // (x,y), where
        // c = (3-sqrt(3))/6
        double x1 = x0 - i1 + G2; // Offsets for middle cornerin (x,y) unskewed coords
        double y1 = y0 - j1 + G2;
    ...
    // Details can be found where this table is
    // used, in the 4D noise method.
    private static int[][] simplex = new int[][]{new int[]{0,1,2,3},new int[]{0,1,3,2},new int[]{0,0,0,0},new int[]{0,2,3,1},new int[]{0,0,0,0},new int[]{0,0,0,0},new int[]{0,0,0,0},new int[]{1,2,3,0},
